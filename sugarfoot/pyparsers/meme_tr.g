...
foo :fnobj :ast = 'var-def' :id expr(fnobj) ->  fnobj.emit_var_decl(ast, id)
               ...
               | 'pop' expr(fnobj) -> fnobj.emit_pop(ast)
               ...
               | '=' ['index' :elhs :eidx] expr(fnobj):rhs apply('expr' fnobj eidx):idx apply('expr' fnobj elhs):lhs -> fnobj.emit_index_assignment(ast, lhs, idx, rhs)

...
class Compiler(ASTBuilder):
    ...
    def compile(self):
        self.line_offset = 0
        self.parser = MemeParser(open(os.path.join(os.path.dirname(__file__), sys.argv[1]), 'r').read())
        ...
        print "done parsing. Translating..."
    ...
    def dump(self, core):
        with open(sys.argv[2] + "/core.img", "w") as fp:
            # header
